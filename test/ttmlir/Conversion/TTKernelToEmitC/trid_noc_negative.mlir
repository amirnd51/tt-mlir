...
module {
  ...
  func.func @bad_trid() {
    ...
    ttkernel.noc_async_write_one_packet_with_trid(%src, core[%x, %x], %dst, %size, %bad_trid) : (i32, index, index, i32, i32, i32) -> ()
    return
  }
  ...
  func.func @bad_noc() {
    ...
    ttkernel.noc_async_write_one_packet_with_trid(%src, core[%x, %x], %dst, %size, %trid_ok, %bad_noc) : (i32, index, index, i32, i32, i32, i8) -> ()
    return
  }
}
