...
module {
  ...
  ttkernel.noc_async_write_one_packet_with_trid(%src, core[%x, %x], %dst, %size, %minus_one, %noc0) : (i32, index, index, i32, i32, i32, i8) -> ()
}
...
module {
  ...
  ttkernel.noc_async_write_one_packet_with_trid(%src, core[%x, %x], %dst, %size, %trid, %two_i8) : (i32, index, index, i32, i32, i32, i8) -> ()
}
...
func.func @test_noc_inline_dw_write_wrong_x_type() {
  ...
  // expected-error @below {{use of value '%bad_x' expects different type than prior uses}}
...
func.func @test_noc_inline_dw_write_wrong_val_type() {
  ...
  "ttkernel.noc_inline_dw_write"(%x, %y, %dst, %bad_val, %be, %noc) : (index, index, i32, i32, i8, i8) -> ()
  return
}
...
func.func @test_noc_inline_dw_write_wrong_byte_enable_type() {
  ...
  "ttkernel.noc_inline_dw_write"(%x, %y, %dst, %val, %bad_be, %noc) : (index, index, i32, i32, i8, i8) -> ()
  return
}
...
func.func @test_noc_inline_dw_write_wrong_noc_id_type() {
  ...
  "ttkernel.noc_inline_dw_write"(%x, %y, %dst, %val, %be, %bad_noc) : (index, index, i32, i32, i8, i8) -> ()
  return
}
