...
// --- Identity MeshShard splits segments but stays on device ---
// Identity MeshShard ops are not CPU-hoisted; they act as barriers
// that partition the surrounding compute into separate segments.
...
// Both the identity MeshShard and the all_gather act as barriers,
