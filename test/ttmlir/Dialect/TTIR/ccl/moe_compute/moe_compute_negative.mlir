...
module attributes {} {
  func.func @moe_compute_bad_intermediate(
    ...
    %0:6 = "ttir.moe_compute"(%inp, %idx, %scores, %map, %w01, %w2)
      <{layer_id = 0 : ui32,
...
module attributes {} {
  func.func @moe_compute_bad_cluster_axis(
      %inp: tensor<1x1x128x256xbf16>,
      %idx: tensor<1x1x128x4xi64>,
      %scores: tensor<1x1x128x4xbf16>,
      %map: tensor<1x1x16x4xi64>,
...
// CHECK: error: 'ttir.moe_compute' op cluster_axis must be 0 or 1

// -----

// prepare_moe_compute_w0_w1_weights: hidden_size must be a positive multiple of 32
module attributes {} {
  func.func @prep_w0_w1_bad_hidden(
      %w0: tensor<1x16x256x128xbf16>,
      %w1: tensor<1x16x256x128xbf16>)
    -> tensor<8x1x16x32x256x128xbf16> {
    %0 = "ttir.prepare_moe_compute_w0_w1_weights"(%w0, %w1)
      <{operandSegmentSizes = array<i32: 1, 1, 0, 0>,
        hidden_size = 100 : ui32,
...
// CHECK: error: 'ttir.prepare_moe_compute_w0_w1_weights' op hidden_size must be a positive multiple of 32
