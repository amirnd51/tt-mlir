...
// =========================================================================
// Pattern 3: interleaved-pair RoPE (HiDream-style)
// =========================================================================

// HiDream's apply_rope chain at TTIR level (pattern captured from
// transformer_hidream_image.apply_rope lowering). The matcher should fold the
// entire reshape -> slice -> reshape -> broadcast -> multiply -> add -> reshape
// chain into a single ttir.rotary_embedding (with surrounding permutations
// for interleaved <-> rotate-half conversion).
